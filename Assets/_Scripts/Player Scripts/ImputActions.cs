...
//     version 1.3.0
//     from Assets/_Scripts/Player Scripts/ImputActions.inputactions
//
...
public partial class @ImputActions : IInputActionCollection2, IDisposable
{
        ...
        },
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""New action"",
                    ""type"": ""Button"",
                    ""id"": ""3f94a8a8-c6db-42b8-b296-012a713477ee"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""f3fe3011-11a7-4da1-9165-7693889439bc"",
                    ""path"": """",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": []
        ...
        m_PlayerMain_LoseGame = m_PlayerMain.FindAction("LoseGame", throwIfNotFound: true);
        m_PlayerMain_WinGame = m_PlayerMain.FindAction("WinGame", throwIfNotFound: true);
        // HUD
        m_HUD = asset.FindActionMap("HUD", throwIfNotFound: true);
        m_HUD_SkillTree = m_HUD.FindAction("SkillTree", throwIfNotFound: true);
    ...
    private readonly InputAction m_PlayerMain_LoseGame;
    private readonly InputAction m_PlayerMain_WinGame;
    public struct PlayerMainActions
    {
        private @ImputActions m_Wrapper;
        public PlayerMainActions(@ImputActions wrapper) { m_Wrapper = wrapper; }
        public InputAction @Move => m_Wrapper.m_PlayerMain_Move;
        public InputAction @Jump => m_Wrapper.m_PlayerMain_Jump;
        public InputAction @Attack => m_Wrapper.m_PlayerMain_Attack;
        public InputAction @LoseGame => m_Wrapper.m_PlayerMain_LoseGame;
        public InputAction @WinGame => m_Wrapper.m_PlayerMain_WinGame;
        ...
        public void SetCallbacks(IPlayerMainActions instance)
        {
            if (m_Wrapper.m_PlayerMainActionsCallbackInterface != null)
            {
                ...
                @LoseGame.started -= m_Wrapper.m_PlayerMainActionsCallbackInterface.OnLoseGame;
                @LoseGame.performed -= m_Wrapper.m_PlayerMainActionsCallbackInterface.OnLoseGame;
                @LoseGame.canceled -= m_Wrapper.m_PlayerMainActionsCallbackInterface.OnLoseGame;
                @WinGame.started -= m_Wrapper.m_PlayerMainActionsCallbackInterface.OnWinGame;
                @WinGame.performed -= m_Wrapper.m_PlayerMainActionsCallbackInterface.OnWinGame;
                @WinGame.canceled -= m_Wrapper.m_PlayerMainActionsCallbackInterface.OnWinGame;
            }
    ...
    private readonly InputAction m_HUD_SkillTree;
    private readonly InputAction m_HUD_Newaction;
    public struct HUDActions
    {
        private @ImputActions m_Wrapper;
        public HUDActions(@ImputActions wrapper) { m_Wrapper = wrapper; }
        public InputAction @SkillTree => m_Wrapper.m_HUD_SkillTree;
        ...
        public void SetCallbacks(IHUDActions instance)
        {
            ...
            {
                @SkillTree.started -= m_Wrapper.m_HUDActionsCallbackInterface.OnSkillTree;
                @SkillTree.performed -= m_Wrapper.m_HUDActionsCallbackInterface.OnSkillTree;
                @SkillTree.canceled -= m_Wrapper.m_HUDActionsCallbackInterface.OnSkillTree;
    ...
    {
        private @ImputActions m_Wrapper;
        public SkillTreeActions(@ImputActions wrapper) { m_Wrapper = wrapper; }
